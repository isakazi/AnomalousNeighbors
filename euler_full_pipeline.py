...
if __name__ == '__main__':
    ...
    subprocess.call(
        ...
        f" --num_nodes_file {num_nodes_file} --output {args.output} --predict --num_epochs {args.num_epochs}", shell=True)
    ...
    subprocess.call(
        ...
        f" --output {args.output} --index_to_node {index_to_node} --false_positive_weight {args.false_positive_weight}", shell=True)
